...
PARAMS = {
  ...
  "r_daily_loss":         {"label":"Daily loss limit","desc":"Stop all trading if cumulative daily loss exceeds this","group":"Prajnan RSI2","section":"Risk management","dot":"dot-purple","type":"int","default":20000,"unit":"₹","svc":"prajnan-agent"},
        "r_trend_type":  {"label":"Trend filter type","desc":"Daily trend filter: EMA or SMA","group":"Prajnan RSI2","section":"Signal","dot":"dot-teal","type":"select","opts":["EMA","SMA"],"default":"EMA","unit":"","svc":"prajnan-agent","file_map":(f"{P}/rsi2_scanner.py","TREND_FILTER_TYPE","quoted")},
        "r_timeframe":   {"label":"Signal timeframe","desc":"Candle timeframe for RSI(2) signal (trend filter stays Daily)","group":"Prajnan RSI2","section":"Signal","dot":"dot-teal","type":"select","opts":["1","3","5","10","15","30","60"],"default":"5","unit":"min","svc":"prajnan-agent","file_map":(f"{P}/rsi2_scanner.py","TIMEFRAME","simple")},
  ...
  "c_daily_loss":         {"label":"Daily loss limit","desc":"Stop new weekly rolls if daily loss exceeds this","group":"Prajnan Calendar","section":"Risk management","dot":"dot-purple","type":"int","default":30000,"unit":"₹","svc":"prajnan-agent"},
    ...
    "s18_sl_mode":          {"label":"Stop loss mode","desc":"POINTS = fixed points of option price, PERCENT = pct of option price","group":"18SMA","section":"Target & stop loss","dot":"dot-amber","type":"select","opts":["POINTS","PERCENT"],"default":"POINTS","unit":"","svc":"18sma-agent","file_map": (S18,"SL_MODE","quoted")},
    "s18_sl_value":         {"label":"Stop loss value","desc":"Meaning depends on SL mode (points or percent of option price)","group":"18SMA","section":"Target & stop loss","dot":"dot-amber","type":"float","default":15.0,"unit":"","svc":"18sma-agent","file_map": (S18,"SL_VALUE","simple")},
    ...
    # ---- VWAP ----
    "vwap_timeframe": {"label":"Timeframe","desc":"Candle timeframe (minutes) for VWAP+SD bands","group":"VWAP","section":"Signal","dot":"dot-blue","type":"select","opts":["1","2","3","5","10","15","30","60"],"default":"5","unit":"min","svc":"vwap-agent","file_map": (VWAP,"TIMEFRAME","simple")},
