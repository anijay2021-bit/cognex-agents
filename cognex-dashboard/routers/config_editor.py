...
TS = f"{BASE}/trishul-agent/config/settings.py"
...
PARAMS = {
  # ── TRISHUL ──────────────────────────────────────────────────────────────
  "t_product_type":       {"label":"Product type","desc":"INTRADAY (MIS) — auto SQ off 3 PM · CARRYFORWARD (NRML) — hold overnight","group":"Trishul","section":"Product type","dot":"dot-gray","type":"select","opts":["INTRADAY","CARRYFORWARD"],"default":"INTRADAY","unit":"","svc":"trishul-agent","file_map": (TS,"PRODUCT_TYPE","quoted")},
  "t_rsi2_oversold":      {"label":"RSI2 oversold threshold","desc":"Buy CE when RSI2 drops below this value","group":"Trishul","section":"Entry — CE (buy call)","dot":"dot-teal","type":"int","default":10,"unit":"","svc":"trishul-agent","file_map": (TS,"RSI2_OVERSOLD","simple")},
  "t_green_candle":       {"label":"Require green candle","desc":"Previous 15-min candle must be green before CE entry","group":"Trishul","section":"Entry — CE (buy call)","dot":"dot-teal","type":"bool","default":True,"unit":"","svc":"trishul-agent","file_map": (TS,"REQUIRE_GREEN_CANDLE","simple")},
  ...
  "t_rsi2_overbought":    {"label":"RSI2 overbought threshold","desc":"Buy PE when RSI2 rises above this value","group":"Trishul","section":"Entry — PE (buy put)","dot":"dot-teal","type":"int","default":90,"unit":"","svc":"trishul-agent","file_map": (TS,"RSI2_OVERBOUGHT","simple")},
  "t_red_candle":         {"label":"Require red candle","desc":"Previous 15-min candle must be red before PE entry","group":"Trishul","section":"Entry — PE (buy put)","dot":"dot-teal","type":"bool","default":True,"unit":"","svc":"trishul-agent","file_map": (TS,"REQUIRE_RED_CANDLE","simple")},
  "t_vol_filter":         {"label":"Volume filter enabled","desc":"Skip PE if bounce volume exceeds multiplier × average","group":"Trishul","section":"Entry — PE (buy put)","dot":"dot-teal","type":"bool","default":True,"unit":"","svc":"trishul-agent","file_map": (TS,"VOLUME_FILTER","simple")},
  "t_vol_mult":           {"label":"Volume ceiling multiplier","desc":"Skip PE if volume > X × 20-period average","group":"Trishul","section":"Entry — PE (buy put)","dot":"dot-teal","type":"float","default":1.8,"unit":"×","svc":"trishul-agent","file_map": (TS,"VOLUME_MULT","simple")},
  "t_rsi2_exit_ce":       {"label":"RSI2 exit — CE","desc":"Exit CE when RSI2 crosses above this value","group":"Trishul","section":"Exit","dot":"dot-coral","type":"int","default":60,"unit":"","svc":"trishul-agent","file_map": (TS,"RSI2_EXIT_CE","simple")},
  "t_rsi2_exit_pe":       {"label":"RSI2 exit — PE","desc":"Exit PE when RSI2 crosses below this value","group":"Trishul","section":"Exit","dot":"dot-coral","type":"int","default":40,"unit":"","svc":"trishul-agent","file_map": (TS,"RSI2_EXIT_PE","simple")},
  "t_sma_exit":           {"label":"Exit on 10 SMA touch","desc":"Also exit when spot touches 10 SMA (secondary exit)","group":"Trishul","section":"Exit","dot":"dot-coral","type":"bool","default":True,"unit":"","svc":"trishul-agent","file_map": (TS,"SMA10_EXIT","simple")},
  "t_sl_type":            {"label":"SL basis","desc":"How the stop loss level is calculated","group":"Trishul","section":"Stop loss","dot":"dot-amber","type":"select","opts":["SPOT_CANDLE_LOW","SPOT_CANDLE_HIGH","PREMIUM_PCT"],"default":"SPOT_CANDLE_LOW","unit":"","svc":"trishul-agent","file_map": (TS,"SL_TYPE","quoted")},
  "t_sl_pct":             {"label":"Premium SL %","desc":"Used only when SL basis = PREMIUM_PCT","group":"Trishul","section":"Stop loss","dot":"dot-amber","type":"float","default":50.0,"unit":"%","svc":"trishul-agent","file_map": (TS,"SL_PCT","simple")},
  "t_lots":               {"label":"Lots per trade","desc":"1 lot = 65 units of Nifty","group":"Trishul","section":"Risk management","dot":"dot-purple","type":"int","default":1,"unit":"lots","svc":"trishul-agent","file_map": (TS,"FIXED_LOTS","simple")},
  "t_daily_loss":         {"label":"Daily loss limit","desc":"Stop all trading if cumulative daily loss exceeds this","group":"Trishul","section":"Risk management","dot":"dot-purple","type":"int","default":15000,"unit":"₹","svc":"trishul-agent","file_map": (TS,"MAX_DAILY_LOSS","simple")},
  "t_vix":                {"label":"VIX threshold","desc":"Skip all trades when India VIX is above this","group":"Trishul","section":"Risk management","dot":"dot-purple","type":"float","default":16.0,"unit":"","svc":"trishul-agent","file_map": (TS,"VIX_CEILING","simple")},
  "t_min_dte":            {"label":"Min days to expiry","desc":"Skip if weekly expiry has fewer days remaining","group":"Trishul","section":"Risk management","dot":"dot-purple","type":"int","default":3,"unit":"days","svc":"trishul-agent","file_map": (TS,"MIN_DAYS_TO_EXPIRY","simple")},
  "t_scan_from":          {"label":"Scan start time","desc":"Begin scanning from this time IST","group":"Trishul","section":"Timing","dot":"dot-blue","type":"time","default":"09:01","unit":"","svc":"trishul-agent","file_map": (TS,"SCAN_FROM","quoted")},
  "t_scan_interval":      {"label":"Scan interval","desc":"Re-check signal every X minutes","group":"Trishul","section":"Timing","dot":"dot-blue","type":"int","default":15,"unit":"min","svc":"trishul-agent","file_map": (TS,"SCAN_INTERVAL_MIN","simple")},
  "t_no_entry_after":     {"label":"No new entries after","desc":"Stop taking new positions after this time IST","group":"Trishul","section":"Timing","dot":"dot-blue","type":"time","default":"14:30","unit":"","svc":"trishul-agent","file_map": (TS,"NO_ENTRY_AFTER","quoted")},
  "t_time_exit":          {"label":"Force-exit time","desc":"Square off all open positions before this time IST","group":"Trishul","section":"Timing","dot":"dot-blue","type":"time","default":"15:00","unit":"","svc":"trishul-agent","file_map": (TS,"TIME_EXIT","quoted")},
  # ── PRAJNAN RSI2 ─────────────────────────────────────────────────────────
