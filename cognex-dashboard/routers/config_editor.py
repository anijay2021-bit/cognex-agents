...
PARAMS = {
  # ── TRISHUL ──────────────────────────────────────────────────────────────
  "t_product_type":       {"label":"Product type","desc":"INTRADAY (MIS) — auto SQ off 3 PM · CARRYFORWARD (NRML) — hold overnight","group":"Trishul","section":"Product type","dot":"dot-gray","type":"select","opts":["INTRADAY","CARRYFORWARD"],"default":"INTRADAY","unit":"","svc":"trishul-agent"},
  "t_rsi2_oversold":      {"label":"RSI2 oversold threshold","desc":"Buy CE when RSI2 drops below this value","group":"Trishul","section":"Entry — CE (buy call)","dot":"dot-teal","type":"int","default":10,"unit":"","svc":"trishul-agent","file_map":(f"{T}/signal_engine.py","oversold_threshold","inline_lt")},
  "t_green_candle":       {"label":"Require green candle","desc":"Previous 15-min candle must be green before CE entry","group":"Trishul","section":"Entry — CE (buy call)","dot":"dot-teal","type":"bool","default":True,"unit":"","svc":"trishul-agent"},
  "t_trend_ce":           {"label":"Trend filter — CE","desc":"Daily trend requirement for CE entries","group":"Trishul","section":"Entry — CE (buy call)","dot":"dot-teal","type":"select","opts":["ABOVE_200EMA","DISABLED"],"default":"ABOVE_200EMA","unit":"","svc":"trishul-agent"},
  "t_rsi2_overbought":    {"label":"RSI2 overbought threshold","desc":"Buy PE when RSI2 rises above this value","group":"Trishul","section":"Entry — PE (buy put)","dot":"dot-teal","type":"int","default":90,"unit":"","svc":"trishul-agent","file_map":(f"{T}/signal_engine.py","overbought_threshold","inline_gt")},
  "t_red_candle":         {"label":"Require red candle","desc":"Previous 15-min candle must be red before PE entry","group":"Trishul","section":"Entry — PE (buy put)","dot":"dot-teal","type":"bool","default":True,"unit":"","svc":"trishul-agent"},
  "t_vol_filter":         {"label":"Volume filter enabled","desc":"Skip PE if bounce volume exceeds multiplier × average","group":"Trishul","section":"Entry — PE (buy put)","dot":"dot-teal","type":"bool","default":True,"unit":"","svc":"trishul-agent"},
  "t_vol_mult":           {"label":"Volume ceiling multiplier","desc":"Skip PE if volume > X × 20-period average","group":"Trishul","section":"Entry — PE (buy put)","dot":"dot-teal","type":"float","default":1.8,"unit":"×","svc":"trishul-agent"},
  "t_rsi2_exit_ce":       {"label":"RSI2 exit — CE","desc":"Exit CE when RSI2 crosses above this value","group":"Trishul","section":"Exit","dot":"dot-coral","type":"int","default":60,"unit":"","svc":"trishul-agent"},
  "t_rsi2_exit_pe":       {"label":"RSI2 exit — PE","desc":"Exit PE when RSI2 crosses below this value","group":"Trishul","section":"Exit","dot":"dot-coral","type":"int","default":40,"unit":"","svc":"trishul-agent"},
  "t_sma_exit":           {"label":"Exit on 10 SMA touch","desc":"Also exit when spot touches 10 SMA (secondary exit)","group":"Trishul","section":"Exit","dot":"dot-coral","type":"bool","default":True,"unit":"","svc":"trishul-agent"},
  "t_sl_type":            {"label":"SL basis","desc":"How the stop loss level is calculated","group":"Trishul","section":"Stop loss","dot":"dot-amber","type":"select","opts":["SPOT_CANDLE_LOW","SPOT_CANDLE_HIGH","PREMIUM_PCT"],"default":"SPOT_CANDLE_LOW","unit":"","svc":"trishul-agent"},
  "t_sl_pct":             {"label":"Premium SL %","desc":"Used only when SL basis = PREMIUM_PCT","group":"Trishul","section":"Stop loss","dot":"dot-amber","type":"float","default":50.0,"unit":"%","svc":"trishul-agent"},
  "t_lots":               {"label":"Lots per trade","desc":"1 lot = 65 units of Nifty","group":"Trishul","section":"Risk management","dot":"dot-purple","type":"int","default":1,"unit":"lots","svc":"trishul-agent"},
  "t_daily_loss":         {"label":"Daily loss limit","desc":"Stop all trading if cumulative daily loss exceeds this","group":"Trishul","section":"Risk management","dot":"dot-purple","type":"int","default":15000,"unit":"₹","svc":"trishul-agent"},
  "t_vix":                {"label":"VIX threshold","desc":"Skip all trades when India VIX is above this","group":"Trishul","section":"Risk management","dot":"dot-purple","type":"float","default":16.0,"unit":"","svc":"trishul-agent"},
  "t_min_dte":            {"label":"Min days to expiry","desc":"Skip if weekly expiry has fewer days remaining","group":"Trishul","section":"Risk management","dot":"dot-purple","type":"int","default":3,"unit":"days","svc":"trishul-agent"},
  "t_scan_from":          {"label":"Scan start time","desc":"Begin scanning from this time IST","group":"Trishul","section":"Timing","dot":"dot-blue","type":"time","default":"09:01","unit":"","svc":"trishul-agent"},
  "t_scan_interval":      {"label":"Scan interval","desc":"Re-check signal every X minutes","group":"Trishul","section":"Timing","dot":"dot-blue","type":"int","default":15,"unit":"min","svc":"trishul-agent"},
  "t_no_entry_after":     {"label":"No new entries after","desc":"Stop taking new positions after this time IST","group":"Trishul","section":"Timing","dot":"dot-blue","type":"time","default":"14:30","unit":"","svc":"trishul-agent"},
  "t_time_exit":          {"label":"Force-exit time","desc":"Square off all open positions before this time IST","group":"Trishul","section":"Timing","dot":"dot-blue","type":"time","default":"15:00","unit":"","svc":"trishul-agent"},
  ...
  "r_lots":               {"label":"Lots per trade","desc":"1 lot = 65 units of Nifty","group":"Prajnan RSI2","section":"Risk management","dot":"dot-purple","type":"int","default":10,"unit":"lots","svc":"prajnan-agent","file_map":(f"{P}/rsi2_scanner.py","RSI2_LOTS","simple")},
  ...
  # ── PRAJNAN EMA+OBV ──────────────────────────────────────────────────────
  "e_product_type":       {"label":"Product type","desc":"INTRADAY (MIS) · CARRYFORWARD (NRML)","group":"Prajnan EMA+OBV","section":"Product type","dot":"dot-gray","type":"select","opts":["INTRADAY","CARRYFORWARD"],"default":"INTRADAY","unit":"","svc":"prajnan-agent"},
  ...
  "e_target_mult":        {"label":"Target multiplier","desc":"Target = entry premium × this (1.4 = 40% profit)","group":"Prajnan EMA+OBV","section":"Target & stop loss","dot":"dot-amber","type":"float","default":1.4,"unit":"×","svc":"prajnan-agent"},
  ...
  "e_lots":               {"label":"Lots per trade","desc":"1 lot = 65 units of Nifty","group":"Prajnan EMA+OBV","section":"Risk management","dot":"dot-purple","type":"int","default":10,"unit":"lots","svc":"prajnan-agent","file_map":(f"{P}/ema_obv_scanner.py","EMA_LOTS","simple")},
  ...
  "e_entry_from":         {"label":"Entries valid from","desc":"No entries before this time (opening noise)","group":"Prajnan EMA+OBV","section":"Timing","dot":"dot-blue","type":"time","default":"09:30","unit":"","svc":"prajnan-agent"},
  "e_no_entry_after":     {"label":"No new entries after","desc":"Stop new entries after this time IST","group":"Prajnan EMA+OBV","section":"Timing","dot":"dot-blue","type":"time","default":"14:45","unit":"","svc":"prajnan-agent"},
  "e_squareoff":          {"label":"EOD square-off","desc":"Exit all positions at this time IST","group":"Prajnan EMA+OBV","section":"Timing","dot":"dot-blue","type":"time","default":"15:25","unit":"","svc":"prajnan-agent"},
  ...
  "c_sl_candle":          {"label":"SL check interval","desc":"Check SL on every X-min candle close, not tick-by-tick","group":"Prajnan Calendar","section":"Stop loss logic","dot":"dot-amber","type":"int","default":5,"unit":"min","svc":"prajnan-agent"},
  ...
  "c_roll_entry":         {"label":"Weekly roll — entry time","desc":"Sell new weekly straddle at this time IST","group":"Prajnan Calendar","section":"Weekly roll","dot":"dot-blue","type":"time","default":"15:26","unit":"","svc":"prajnan-agent"},
