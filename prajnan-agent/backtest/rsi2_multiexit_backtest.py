...
def run():
    ...
    for cfg in EXIT_CONFIGS:
        ...
        if trades:
            ...
            path = f"/home/anijay2021/prajnan-agent/backtest/rsi2_{cfg['label']}.csv"
    ...
    summary_df.to_csv("/home/anijay2021/prajnan-agent/backtest/rsi2_comparison.csv", index=False)
